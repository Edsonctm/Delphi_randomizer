...
begin
  ...
  Randomize;
  lblSorteado.EditValue := 'O número sorteado foi: ' + IntToStr(numeroSorteado);
end;
...
begin
  ...
  if (edNumeroInicial.EditText = '') OR (edNumeroFinal.EditText = '') then
     mensagem.Add('Número inicial ou final não informado.')
  else if StrToInt(edNumeroInicial.EditValue) >= StrToInt(edNumeroFinal.EditValue) then
    mensagem.Add('O número inicial deve ser menor que o número final.');
